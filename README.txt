...
However, its written in c for .pgm image format. Keeping in mind the application of line segment detection in robot vision. I have modified it to use this 
robust algorithm for .jpg format. So, that you can easily integrate with your ROS repository or other vision or image processing related codes.   
